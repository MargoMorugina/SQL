...
select created_on,name from students where created_on = '2021-03-26 00:00:00'; 
...
select created_on,name from students where created_on = '2021-07-12 00:00:00';
...
select id,name from students where  180 < id and id < 190;
--25. Вывести пользователя у которых id между 180 и 190
select id,name from students where  180 < id and id < 190;
--26. Вывести пользователей где password равен 12333, 1m313, 123313 
select name,password from students where  password = '12333' or password = '1m313' or password = '1m313';
--27. Вывести пользователей где created_on равен 2020-10-03 00:00:00, 2021-05-19 00:00:00, 2021-03-26 00:00:00
select name,created_on from students where  password = '12333' or password = '1m313' or password = '1m313';
